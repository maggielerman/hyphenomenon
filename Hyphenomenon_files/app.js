      ...
      if (cart.item_count == 0) {
        ...
        cart_items_html += '<li class="mm-label">' +
          ...
          '<li class="mm-subtitle clearfix">';
            ...
            cart_items_html += '<textarea id="cart-note" name="note" rows="2" placeholder="Order Notes" class="clearfix">'+cart_note+'</textarea>';
...
$(function() {
  ...
  $('.slider').flexslider({
    ...
    if($('.product_slider img').length == 1) {
...
selectCallback = function(variant, selector) {
  ...
  if (variant && variant.available == true) {
    ...
    if (variant.price > 0) {
      ...
      $('.current_price', $product).html("Free To Download!");
    }
